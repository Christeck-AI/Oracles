...
export const RUNES_DECK: RuneData[] = [
  ...
  // --- AETT 2: HEIMDALL'S AETT (Crisis, pruebas, destino y fuerza cósmica) ---
  {
    ...
    symbolism: {
      en: "The rune resembles a structural beam shattered by cross-forces. Associated with Urd (the Norn of the past) and the destructive aspect of Ymir, it is the cosmic reset button—the winter storm before spring.",
      es: "La runa se asemeja a una viga estructural destrozada por fuerzas cruzadas. Asociada con Urd (la Norna del pasado) y el aspecto destructivo de Ymir, es el botón de reinicio cósmico: la tormenta de invierno antes de la primavera."
    },
    jungianAnalysis: {
